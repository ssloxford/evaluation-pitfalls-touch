...
parser.add_argument('-phone', default="iPhone 7") # "iPhone 6s Plus", "iPhone 7 Plus", "iPhone 8 Plus","iPhone 6s", "iPhone 7", "iPhone 8","iPhone X", "iPhone XS", "iPhone XS Max"
...
users, user_touches, user_touches_shuffled, session_user_touches = utils.preprocessing(dataset_path=args.dataset, game="swipe", \
                                                                                        direction="left", random_state=args.random_state, phone=args.phone)
EERS = []
def user_eer(user):
