...
class ImageGameInstructions: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.title = "Image Game Instructions"
        
        if (!iterationArticleData.isEmpty){
    ...
    @IBAction func bContinue(_ sender: Any) {
        ...
        var nextViewController: ImageGame

        nextViewController = storyBoard.instantiateViewController(withIdentifier: "ImageGame") as! ImageGame
